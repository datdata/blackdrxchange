	...
	class DocDirect_Scripts{
        ...
        public function docdirect_profile_menu( $menu_type="dashboard" ) {
            ...
            <?php } else{
                ...
                <ul>
                    <?php /*?><li><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'dashboard', $user_identity); ?>"><img src="<?php echo esc_url( $avatar );?>" alt="<?php esc_html_e('Avatar','docdirect');?>"  /><?php esc_html_e('Profile','docdirect');?></a></li><?php */?>
