...
if ( ! function_exists( 'docdirect_get_booking_step_four' ) ) {
	function docdirect_get_booking_step_four(){
		...
		if( !empty( $_POST['data_id'] ) ){
			$paypal_enable	= get_user_meta( $_POST['data_id'], 'paypal_enable', true);
			$stripe_enable	= get_user_meta( $_POST['data_id'], 'stripe_enable', true);
		}
		?>
        <div class="bk-payment-methods">
            ...
            <?php if( !empty( $paypal_enable ) && $paypal_enable === 'on' ){?>
            ...
            <?php }?>
            <?php if( !empty( $stripe_enable ) && $stripe_enable === 'on' ){?>
...
if ( ! function_exists( 'docdirect_get_booking_step_five' ) ) {
	function docdirect_get_booking_step_five($user_identity){
		...
		if( empty( $thank_you ) ){
			$thank_you	= esc_html__('Thank you for booking. We have have received you booking. Soon we will get back to you.','docdirect');
		}
		?>
