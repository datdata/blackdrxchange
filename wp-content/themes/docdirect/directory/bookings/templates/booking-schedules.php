							...
							if( !empty( $custom_slot_list[0] ) ){
								foreach( $custom_slot_list  as $key => $value ){
									...
									if( !empty( $start_date ) && !empty( $end_date ) ){
										$date_formate	= date( 'M, d Y',strtotime( $start_date ) ) .'-'. date( 'M, d Y',strtotime( $end_date ) );
									} else if( !empty( $start_date ) && empty( $end_date ) ){
										$date_formate	= date( 'M, d Y',strtotime( $start_date ) );
									} else if( empty( $start_date ) && !empty( $end_date ) ){
										$date_formate	= date( 'M, d Y',strtotime( $end_date ) );
									} else{
