                    ...
                    <div class="row">
                        <div class="tg-otherphotos">
                            ...
                            <div class="gallery-button">
                                <button type="button" id="attach-gallery" class="tg-btn tg-btn-lg"><?php esc_html_e('Choose Photos','docdirect');?></button>
                            </div>
        ...
        <div class="tg-bordertop tg-haslayout">
            <div class="tg-formsection">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <input class="form-control" name="basics[address]" value="<?php echo get_user_meta($user_identity,'address',true); ?>" type="text" placeholder="<?php esc_attr_e('Address','docdirect');?>">
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <input class="form-control" name="basics[user_url]" value="<?php echo esc_url( $user_url ); ?>" type="url" placeholder="<?php esc_attr_e('URL','docdirect');?>">
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
							...
							?><?php */?>
                            <textarea class="form-control" name="basics[description]" placeholder="<?php esc_attr_e('Description','docdirect');?>"><?php echo get_user_meta($user_identity,'description',true); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
