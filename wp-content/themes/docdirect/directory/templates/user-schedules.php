			...
			<div class="col-sm-offset-2 col-sm-10">
                ...
                <div class="form-group">
                    <select name="time_format" class="form-control">
                        <option value="12hour"><?php esc_html_e("Show Time in 12-hour clock",'docdirect');?></option>
                        <option value="24hour"><?php esc_html_e("Show Time in 24-hour clock",'docdirect');?></option>
                    </select>    
                </div>
