        ...
        <div class="tg-bordertop tg-haslayout">
            <div class="tg-reactivate tg-haslayout">
                <div class="col-sm-8">
                    ...
                    <?php 
                    $short_description = fw_get_db_post_option($current_package, 'short_description', true);
                    if( isset( $short_description ) && !empty( $short_description ) ) {?>
                    <div class="tg-description">
                        <p><?php echo do_shortcode( $short_description );?></p>
                    </div>
                    <?php }?>
                </div>
                <div class="col-sm-4">
                    <button type="submit" class="tg-btn tg-btn-lg"><?php esc_html_e('Re-Subscribe now','docdirect');?></button>
                        ...
                        <div class="tg-checkbox">
                            ...
                            <label for="pack-<?php echo esc_attr( $pack->ID );?>">
                                <div class="tg-packages <?php echo esc_attr( $active_class );?>">
                                    ...
                                    <?php }?>
                                    <span class="tg-btn-invoices selected-package"><?php echo esc_attr( 'Select Package','docdirect' );?></span>
                                </div>
                            </label>
                        </div>
                    </div>
