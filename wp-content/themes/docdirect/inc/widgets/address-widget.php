...
if (!class_exists('TG_Address_Widget')) {
    ...
    class TG_Address_Widget extends WP_Widget {
        ...
        public function __construct() {
            ...
            parent::__construct('address_widget', esc_html__('TG Address Widget', 'docdirect'), $widget_ops, $control_ops);
        }
			...
			<ul class="tg-info">
				...
				<?php if ( !empty($email) ) {?>
					<li>
						...
						<em><a href="<?php echo esc_attr( $email );?>"><?php echo esc_attr( $email );?></a></em>
					</li>
				<?php } ?>
				<?php if ( !empty($phone) ) {?>
				<li>
