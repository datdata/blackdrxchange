...
$options = array(
	...
	'user_type' => array(
        ...
        'choices' => docdirect_prepare_custom_posts('directory_type',array(
				'all' => esc_html__('All Catgories', 'docdirect'),
			)
		)
    ),
	'show_users' => array(
	...
	'order' => array(
        ...
        'desc' => esc_html__('', 'docdirect'),
        'choices' => array(
            'yes' => esc_html__('DESC', 'docdirect'),
            'no' => esc_html__('ASC', 'docdirect'),
        ),
        'no-validate' => false,
    ),
);
