            ...
            <div class="tg-usercontactinfo">
              ...
              <ul class="tg-doccontactinfo">
                ...
                <?php if( !empty( $current_author_profile->user_url ) ) {?>
                    <li><i class="fa fa-link"></i><a href="<?php echo esc_attr( $current_author_profile->user_url);?>" target="_blank"><?php echo esc_attr( $current_author_profile->user_url);?></a></li>
                <?php }?>
              </ul>
              <?php 
				if(  !empty( $facebook ) 
              ...
              <?php /*?><div class="tg-userpubliclink">
                <h3><?php esc_html_e('Public Profile URL','docdirect');?></h3>
