            ...
            <div class="modal fade tg-user-modal" tabindex="-1" role="dialog">
				<div class="tg-modal-content">
					<ul class="tg-modaltabs-nav" role="tablist">
						...
						<li role="presentation"><a href="#tg-signup-formarea" aria-controls="tg-signup-formarea" role="tab" data-toggle="tab"><?php esc_html_e('Sign Up','docdirect_core');?></a></li>
					</ul>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group tg-checkbox">
                                                ...
                                                <a class="tg-forgot-password" href="<?php echo esc_url( $forgot_passwrod); ?>">
                                                    <i><?php esc_html_e('Forgot Password','');?></i>
							...
							if( $enable_resgistration == 'enable') {
								...
								<fieldset>
									...
									<div class="form-group tg-checkbox">
										...
										<label><input name="terms" class="form-control" type="checkbox"><?php esc_html_e(' I agree with the terms and conditions','docdirect_core');?></label>
