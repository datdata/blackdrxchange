	...
	class TG_Appointments {
		...
		public function docdirect_appointment_detail(){
			...
			if ( function_exists('fw_get_db_settings_option') 
				...
				$bk_payment_date = fw_get_db_post_option($post->ID, 'bk_payment_date', true);
				$bk_transaction_status = fw_get_db_post_option($post->ID, 'bk_transaction_status', true);
				$bk_paid_amount = fw_get_db_post_option($post->ID, 'bk_paid_amount', true);
				$bk_user_from = fw_get_db_post_option($post->ID, 'bk_user_from', true);
				$payment_status = fw_get_db_post_option($post->ID, 'payment_status', true);
				$bk_status = fw_get_db_post_option($post->ID, 'bk_status', true);
				$bk_timestamp = fw_get_db_post_option($post->ID, 'bk_timestamp', true);
				$bk_user_to = fw_get_db_post_option($post->ID, 'bk_user_to', true);
				$bk_payment = fw_get_db_post_option($post->ID, 'bk_payment', true);
				$bk_booking_note = fw_get_db_post_option($post->ID, 'bk_booking_note', true);
				$bk_useremail = fw_get_db_post_option($post->ID, 'bk_useremail', true);
				$bk_userphone = fw_get_db_post_option($post->ID, 'bk_userphone', true);
				$bk_username = fw_get_db_post_option($post->ID, 'bk_username', true);
				$bk_subject = fw_get_db_post_option($post->ID, 'bk_subject', true);
				$bk_slottime = fw_get_db_post_option($post->ID, 'bk_slottime', true);
				$bk_booking_date = fw_get_db_post_option($post->ID, 'bk_booking_date', true);
				$bk_currency = fw_get_db_post_option($post->ID, 'bk_currency', true);
				$bk_service = fw_get_db_post_option($post->ID, 'bk_service', true);
				$bk_category = fw_get_db_post_option($post->ID, 'bk_category', true);
